...
public class SimplifiedOdometryRobot {
    ...
    private final double ODOM_INCHES_PER_COUNT   = 1.2598425*Math.PI/2000.0;   //  GoBilda Odometry Pod 32mm
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("drivelf", DcMotor.Direction.REVERSE);
        rightFrontDrive = setupDriveMotor("driverf", DcMotor.Direction.FORWARD);
        leftBackDrive  = setupDriveMotor( "drivelb", DcMotor.Direction.REVERSE);
        rightBackDrive = setupDriveMotor( "driverb",DcMotor.Direction.FORWARD);
